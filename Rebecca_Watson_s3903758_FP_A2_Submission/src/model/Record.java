...
public class Record {
	...
	/**
	 * toString method for the record object variables, mainly used for testing
	 * purposes
	 */
	...
	public String toCSVString() {
		return String.format("%s, %s, %s, %s, %s, %s", recordDate, recordTime, weightKG, tempCELC, bloodPressure,
				notes);
	}
