...
public class UserInputValidator {
	 ...
	 */
	private static final String USERNAME_AND_PASSWORD_PATTERN = "^[a-zA-Z0-9]([._-](?![._-])|[a-zA-Z0-9]){3,18}[a-zA-Z0-9]$";

	private static final Pattern patternSimple = Pattern.compile(NAME_PATTERN);

	private static final Pattern patternStrict = Pattern.compile(USERNAME_AND_PASSWORD_PATTERN);
